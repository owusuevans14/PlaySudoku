class Puzzle {
    ...
    createPuzzle() {  
        ...
        //board is ran through shifters for removing obviousness                  
        return this.shifters() 
    }

    validate(){
        let validation = new Validity(this.board, this.boardSize);
    ...
    shifters(){
        let shifter = new Shifters(this.board, this.boardSize, this.boxSize)
        shifter.runShifters()
